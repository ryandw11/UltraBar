...
/**
 * Controls the boss bar messages.
 * TODO rewrite this at some point in time.
 */
        ...
        if (prog < 0) {
            ...
            for (Player p : Bukkit.getOnlinePlayers()) {
                if (b.getConfig().getBoolean("BossBarMessages.World_Whitelist_Enabled")) { //Bug Fix in 1.6.1 | Capitalization error.
                    if (b.getConfig().getStringList("BossBarMessages.World_Whitelist").contains(p.getWorld().getName())) { // Bug Fix
