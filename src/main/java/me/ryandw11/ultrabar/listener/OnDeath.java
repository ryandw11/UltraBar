...
public class OnDeath implements Listener {
    ...
    public void onPlayerDeath(PlayerDeathEvent e) {
        if (plugin.getConfig().getBoolean("OnDeath.BossBar.Enabled")) {
            String msg = plugin.papiTranslate.getMessage(plugin.chatColorUtil.translateChatColor(plugin.getConfig().getString("OnDeath.BossBar.Message")), e.getEntity());
        ...
        if (plugin.getConfig().getBoolean("OnDeath.Title.Enabled")) {
            String msg = plugin.papiTranslate.getMessage(plugin.chatColorUtil.translateChatColor(plugin.getConfig().getString("OnDeath.Title.Message")), e.getEntity());
            String submsg = plugin.papiTranslate.getMessage(plugin.chatColorUtil.translateChatColor(plugin.getConfig().getString("OnDeath.Title.SubTitle")), e.getEntity());
        ...
        if (plugin.getConfig().getBoolean("OnDeath.ActionBar.Enabled")) {
            String msg = plugin.papiTranslate.getMessage(plugin.chatColorUtil.translateChatColor(plugin.getConfig().getString("OnDeath.ActionBar.Message")), e.getEntity());
